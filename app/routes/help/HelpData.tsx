...
export const helpData: HelpDataItem[] = [
    {
        ...
        description: "Kontakter er personer som har tilgang til kundeportalen. En juridisk kontakt er den som " +
    ...
    },
    {
        id: "komponenter",
        title: "Komponenter",
        description: "En komponent er en løsning fra FINT. For at organisasjonen skal kunne ta i bruk en løsning fra " +
    ...
    },
    {
        id: "adapter",
        title: "Adapter",
        description: "Ett adapter er påloggingsinformasjon som brukes av fagsystem-adapterne for å få tilgang til " +
    ...
    },
    {
        id: "klienter",
        title: "Klienter",
        description: "En klient er påloggingsinformasjon som brukes av en integrasjon for å få tilgang til en " +
    ...
    },
    {
        id: "ressurser",
        title: "Ressurser",
        description: "En ressurs er identifikatoren som styrer en forespørsel mot en komponent til riktig " +
    ...
    },
    {
        ...
        description: "En tilgangspakke benyttes for å sette opp riktige tilganger til klienter du oppretter i " +
    ...
    },
    {
        id: "basistest",
        title: "Basistest",
        description: "En basistest undersøker om alle delene i FINT komponenten fungerer som de skal. I tillegg " +
    ...
    },
    {
        id: "samtykke",
        title: "Samtykke",
        description: "Nedenfor er en liste over tjenester. Klikk på overskriften for å se en fullstendig liste " +
