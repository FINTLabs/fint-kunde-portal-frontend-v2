...
export async function action({
    ...
    if(!selectedOrganization) {
        selectedOrganization = {name: "TEST ORG", orgNumber: "99999999999", displayName: "Test Organization"};
    }
        ...
        <>
            ...
            {userSession && (
                <Form method="post">
                    <label>
                        Select Organization:
                        <select name="selectedOrg" defaultValue={userSession.selectedOrganization?.name}>
