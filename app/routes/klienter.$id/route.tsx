                ...
                <Table>
                    <Table.Body>
                        <Table.Row>
                            ...
                            <Table.DataCell><CopyButton copyText="3.14"/></Table.DataCell>
                        </Table.Row>
                        <Table.Row>
                            <Table.DataCell>Password</Table.DataCell>
                            <Table.DataCell>**** <Button variant={"tertiary"}
                                                         icon={<ArrowCirclepathIcon title="a11y-title"
                                                                                    fontSize="1.5rem"/>}></Button></Table.DataCell>
                            <Table.DataCell><CopyButton copyText="3.14"/></Table.DataCell>
                        </Table.Row>
                        <Table.Row>
                        ...
                        <Table.Row>
                            ...
                            <Table.DataCell><Button variant={"tertiary"} icon={<DownloadIcon title="a11y-title"
                                                                                             fontSize="1.5rem"/>}></Button></Table.DataCell>
                            <Table.DataCell><CopyButton copyText="3.14"/></Table.DataCell>
                        </Table.Row>
                        <Table.Row>
